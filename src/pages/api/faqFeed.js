...
export default async function handler(req, res) {
  ...
  const feed = new Feed({
    title: `FAQs - ${currentCompany?.meta_title || `${currentCompany?.name}`} - RSS Feed`,
    description: `FAQs of ${currentCompany?.meta_title || currentCompany?.sub_type}`,
    id: `${siteUrl}/${slug}/faq`,
    link: `${siteUrl}/${slug}/faq`,
    language: 'en',
    image: currentCompany?.logo_url || `${siteUrl}/images/logo.svg.webp`,
    ...
    currentCompany?.faqs?.forEach((faq) => {
        feed.addItem({
        title: faq.title,
        id: `${siteUrl}/faq/${faq.slug}`,
        link: `${siteUrl}/faq/${faq.slug}`,
