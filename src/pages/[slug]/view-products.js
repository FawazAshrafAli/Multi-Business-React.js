...
export default function ListProductPage({
  ...
  return (
    <>
        ...
        url = {`https://bzindia.in/${currentCompany?.slug}/view-products`}
        />
    ...
    const structuredData = [        
        ...
        JSON.stringify(
            ...
            "itemListElement": [
                ...
                "position": 3,
                "name": "Products",
                "item": `https://bzindia.in/${currentCompany?.slug}/view-products`
                },            
            ]
            }            
        ),                
