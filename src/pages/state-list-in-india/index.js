...
export default function StateListInIndia({
  ...
  return (
    <>
      <SeoHead
      meta_description="Explore the complete list of Indian states with an interactive location map and search option to find state-wise, district-wise, and city-level details across India."
      meta_title={`India State List- Overview | Explore State-Wise, District-Wise & City Locations - ${homeContent?.[0]?.meta_title || ""}`}
      metaTags={metaTags}
      
      blogs={blogs}

      url = {"https://bzindia.in/state-list-in-india/"}
      />
    ...
    const faqs = [
          {
            ...
            answer: "India has a total of 28 states, each with its own government and administrative structure."
          },
          {
            question: "What is the difference between a state and a union territory?",
            answer: "States have their own elected government, while union territories are governed directly by the Central Government or a Lieutenant Governor."
          },
          {
          ...
          {
            question: "What is the capital of India and is it part of any state?",
            answer: "New Delhi is the national capital and it belongs to the Union Territory of Delhi, not any state."
          },
          {
            question: "Can I travel freely between states in India?",
            answer: "Yes, Indian citizens can travel freely between states without restrictions, although local laws and languages may differ."
          },
          {
            question: "Do all Indian states have the same official language?",
              ...
              "@graph": [
                {
                  ...
                  "url": "https://www.bzindia.in/state-list-in-india/",
                  "image": [
                ...
                },
                {
                  ...
                  "hasMap": `https://www.google.com/maps?q=20.5937,78.9629&z=15&output=embed`
                }
              ]
            }
      ),
