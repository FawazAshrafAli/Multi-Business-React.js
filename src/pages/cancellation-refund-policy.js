...
export default function CancellationAndRefundPolicyPage({
  ...
  cancellationAndRefundPolicy, structuredData
}) {
  ...
  return (
    <>
      ...
      meta_title={`Cancellation And Refund Policy - ${homeContent?.[0]?.meta_title || "BZIndia"}`}
      metaTags={metaTags}
      
      blogs={blogs}

      url = {"https://bzindia.in/cancellation-delivery-policy"}
      />
      <Head>
...
export async function getServerSideProps(context) {
  try {   
    ...
    const cancellationAndRefundPolicyRes = await customPage.getCancellationAndRefundPolicy();
    const cancellationAndRefundPolicyData = cancellationAndRefundPolicyRes.data?.[0]; 
    ...
    const structuredData = [
      ...
      JSON.stringify(
          ...
          "itemListElement": [
              ...
              "item": `https://bzindia.in/cancellation-delivery-policy`
              },       
          ]
          }
      ),
      ...
      JSON.stringify(
        {
          ...
          "@type": "ReturnPolicy",
          "name": "BZIndia Return and Refund Policy",
          ...
          "additionalProperty": [
            {
              "@type": "PropertyValue",
              "name": "Support Email",
              "value": "support@bzindia.in"
            },
            {
              "@type": "PropertyValue",
              "name": "Support Phone",
              "value": "+91 75608 66000"
            }
          ]
        }
      )    
    ...
    return {
      props: {
        ...
        metaTags,
        blogs,
        cancellationAndRefundPolicy: cancellationAndRefundPolicyData || {},        
        structuredData
      },
    };
