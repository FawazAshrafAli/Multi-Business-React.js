...
export default function TermsAndConditionsPage({
  ...
  termsAndConditions, structuredData
}) {
  ...
  return (
    <>
      ...
      meta_title={`Terms And Conditions - ${homeContent?.[0]?.meta_title || "BZIndia"}`}
      metaTags={metaTags}
      
      blogs={blogs}

      url = {"https://bzindia.in/terms-conditions"}
      />
      <Head>
...
export async function getServerSideProps(context) {
  try {   
    ...
    const termsAndConditionsRes = await customPage.getTermsAndConditions();
    const termsAndConditionsData = termsAndConditionsRes.data?.[0]; 
    ...
    const structuredData = [
      ...
      JSON.stringify(
        ...
        "itemListElement": [
            ...
            "item": `https://bzindia.in/terms-conditions`
            },       
        ]
        },
        null, 2
