...
const AboutUS = ({blogs, homeContent, aboutUs}) => {    
    ...
    useEffect(() => {
        ...
        setTitle(`About Us - ${homeContent?.meta_title || 'BZIndia - Find the top companies in India'}`);
        }
    ...
    useEffect(() => {
        if (typeof window === 'undefined' || !aboutUs) return;
