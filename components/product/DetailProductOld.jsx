...
<p className="ecom_price">&#8377;{detail
Page?.price}/-  <span>Available: {detailPage?.stock > 0 ? <span className="font_green">In stock</span> : <span className="font_red">Out stock</span>} </span></p>
