...
<section>
  ...
  <section className="multi_serv_slider">
    ...
    <CourseSlider courseDetails={replacedMultipage?.slider_courses || courseDetails} error={courseDetailsError} loading={courseDetailsLoading} company={currentCompany}/>    
...
<section className="resume segments" id="resume" style={{background: "#ecf2ef", padding: "60px 0px", margin: "0px 0px 0px 0px"}}>
          ...
          <div className="col-md-8">
            ...
            <div className="regstrtn-faq-space">
              ...
              <div className="registrsn-fq-scrool-bar-clm">
                <h3>{`${replacedMultipage?.title} FAQs`}</h3>
                <p className="flip"><span className="deg1"></span><span className="deg2"></span><span className="deg3"></span></p>
  ...
  {/* <TestimonialSlider testimonials={replacedMultipage?.testimonials?.length > 0 ? replacedMultipage?.testimonials : fallBackTestimonials} />     */}
    </>
  )
}

export default MultipageEducation