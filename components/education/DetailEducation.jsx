...
const DetailEducation = ({
  ...
  useEffect(() => {
    const fetchCompanyCourseDetails = async () => {
      try {
        const response = await course.getSliderDetails(slug);
              ...
              <div className="home-center">
                  <div className="home-desc-center" data-aos="fade-in">
                      <div className="container">
                          <div className="row">
                              ...
                              <span>
                                ...
                                <span><Link href={`/${company?.slug}`}>{company?.sub_type}</Link></span> » 
                                <span><Link href={`/${company?.slug}/${detailPage?.program_slug}`}>{detailPage?.program_name}</Link></span> » 
                                <span><Link href={`/${company?.slug}/${detailPage?.program_slug}/${detailPage?.specialization_slug}`}>{detailPage?.specialization_name}</Link></span> » 
                    ...
                    <div className="col-md-4">             
                      <DarkEnquiryForm company={company} setMessage={setMessage} setMessageClass={setMessageClass}/>                      
                    </div>  
  ...
  <div id="stick_navbar" style={{padding: "0px 0"}}>
    ...
    <>
      ...
      <NeonPhoneLink currentCompany={company}/>
    </>
    }
  ...
  <section>
    ...
    <section className="multi_serv_slider">
      ...
      <CourseSlider courseDetails={courseDetails} error={courseDetailsError} loading={courseDetailsLoading} />    
  ...
  <section className="resume segments" id="resume" style={{background: "#ecf2ef", padding: "60px 0px", margin: "0px 0px 0px 0px"}}>
    ...
    <section>
      <div className="container-fluid">
        ...
        <div className="course-faq-section my-5" id="faqs-section">        
          <div className="row">
            <div className="col-md-8">
    ...
    <TestimonialSlider testimonials={detailPage?.testimonials?.length > 0 ? detailPage.testimonials : fallBackTestimonials} />      
    </>
  )
}
