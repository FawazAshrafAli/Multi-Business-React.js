...
const TestimonialSlider = ({testimonials, loading}) => {
    ...
    const sliderSettings = {
        ...
        ...(testimonials&&testimonials.length < 3 ? {slidesToShow: testimonials.length}: {})
    }
        ...
        <div className="container">
            ...
            {testimonials?testimonials.slice(0,12).map((testimonial) => (
                ...
                <div className="testmnl-clin-img-bg">
                    ...
                    <img src={testimonial.image_url?testimonial.image_url: '/images/model-2911332_640 1.jpg'} alt={testimonial.name} loading='lazy' />
                    </div>
                </div>
                <div className="testmnl-clin-review-bx">
                    ...
                    <span className="clnt-cmpny-name"> {testimonial.course_name?testimonial.course_name:""}</span>
                    <span className="clnt-cmpny-location">{testimonial.place_name?testimonial.place_name:""}</span>
                    </div>
